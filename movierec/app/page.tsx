  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] p-4">
      ...
      <Card className="w-full max-w-md border-4 border-[#facc15] shadow-2xl bg-white">
        <CardHeader className="bg-[#0F172A] text-center py-6">
          <CardTitle className="text-2xl text-[#facc15]">Login</CardTitle>
          <CardDescription className="text-[#0F172A]">Enter your credentials to access your account</CardDescription>
        </CardHeader>
        <CardContent>
