...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A]-900 p-4">
      ...
      <Card className="w-full max-w-md border-4 border-yellow-400 shadow-2xl bg-white">
        <div className="bg-[#0F172A]-800 py-6 px-4 text-center rounded-t-sm">
          <div className="w-16 h-16 mx-auto mb-2 bg-yellow-400 rounded-full flex items-center justify-center">
            <Film size={32} className="text-bg-[#0F172A]-800" />
          </div>
        ...
        <CardHeader className="pt-6">
          <CardTitle className="text-2xl text-[#0F172A]-800 font-bold">Create an account</CardTitle>
          <CardDescription className="text-[#0F172A]-600">Enter your details to start your movie journey</CardDescription>
        </CardHeader>
        
        <CardContent>
          {success ? (
            <SuccessAlert className="mb-4 bg-[#0F172A]-50 border-[#0F172A]-500 text-[#0F172A]-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-[#0F172A]-800">First Name</Label>
                  <Input 
                    id="firstName" 
                    value={firstName} 
                    onChange={(e) => setFirstName(e.target.value)} 
                    required 
                    className="border-[#0F172A]-300 focus:border-[#0F172A]-500 focus:ring-[#0F172A]-500"
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-[#0F172A]-800">Last Name</Label>
                  <Input 
                    id="lastName" 
                    value={lastName} 
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#0F172A]-800">Email</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-[#0F172A]-800">Password</Label>
                <Input
                  id="password"
                  type="password"
                  value={password}
              ...
              <Button 
                type="submit" 
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-[#0F172A]-900 font-bold py-2 px-4" 
                disabled={isLoading}
              >
        ...
        <CardFooter className="flex justify-center border-t border-[#0F172A]-100 pt-4">
          <p className="text-sm text-[#0F172A]-700">
            Already a member?{" "}
            <Link href="/" className="text-[#0F172A]-600 font-bold hover:text-yellow-600 hover:underline">
              Login
            </Link>
          </p>
        </CardFooter>
