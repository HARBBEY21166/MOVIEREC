...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#192645] p-4">
      ...
      <Card className="w-full max-w-md border-4 border-yellow-400 shadow-2xl bg-white">
        ...
        <CardHeader className="pt-6">
          <CardTitle className="text-2xl text-[#192645] font-bold">Create an account</CardTitle>
          <CardDescription className="text-[#192645]">Enter your details to start your movie journey</CardDescription>
        </CardHeader>
        
        <CardContent>
          {success ? (
            <SuccessAlert className="mb-4 bg-[#192645] border-[#192645] text-[#192645]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-[#192645]">First Name</Label>
                  <Input 
                    id="firstName" 
                    value={firstName} 
                    onChange={(e) => setFirstName(e.target.value)} 
                    required 
                    className="border-[#192645] focus:border-[#192645] focus:ring-[#192645]"
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-[#192645]">Last Name</Label>
                  <Input 
                    id="lastName" 
                    value={lastName} 
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#192645]">Email</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-[#192645]">Password</Label>
                <Input
                  id="password"
                  type="password"
                  value={password}
              ...
              <Button 
                type="submit" 
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-[#192645] font-bold py-2 px-4" 
                disabled={isLoading}
              >
        ...
        <CardFooter className="flex justify-center border-t border-[#192645] pt-4">
          <p className="text-sm text-[#192645]">
            Already a member?{" "}
            <Link href="/" className="text-[#192645] font-bold hover:text-yellow-600 hover:underline">
              Login
            </Link>
          </p>
        </CardFooter>
